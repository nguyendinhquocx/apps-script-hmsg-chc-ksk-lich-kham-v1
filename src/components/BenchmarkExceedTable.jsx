      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-600">
            Hiển thị {exceedTableData.length} ngày có vượt định mức
          </p>
        </div>
            ...
            <div key={index} className="bg-white border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow duration-200">
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center space-x-2">
                  <h3 className="font-medium text-gray-900">{dayData.date}</h3>
                  <span className="px-2 py-1 text-xs bg-red-100 text-red-700 rounded-full">
                    {dayData.totalExceedCategories} hạng mục vượt
                  </span>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                {dayData.exceeds.map((exceedItem, exceedIndex) => (
                  <div key={exceedIndex} className="flex items-center justify-between p-3 bg-gray-50 rounded-md">
                    <div>
